  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/70 bg-card/85 backdrop-blur-md supports-[backdrop-filter]:bg-card/70">
      <div className="container flex h-16 items-center gap-4 px-4 md:px-6">
        <Link
          href="/"
          className="flex min-w-0 shrink-0 items-center gap-2 font-serif text-base font-semibold tracking-wide text-primary-800 dark:text-primary-200 sm:text-lg"
        >
          <BookOpen className="h-6 w-6 shrink-0 text-primary-600" />
